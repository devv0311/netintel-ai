...
The known-correct answer key for `evidence/synthetic/fixtures/`, kept separate per `docs/data/ground-truth-spec.md` §2. (The full-corpus answer key is `../operation-darknet-delhi.ground-truth.json`; see `docs/data/corpus.md`.)
